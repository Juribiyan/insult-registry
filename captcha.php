...
define("img_dir", DOCUMENT_ROOT."/inc/captcha/");
...
$fonts = array(
	array(
		"fname" => "zerch.ttf", // TTF file in /captcha folder
		"size" => array(22,28),	// pixels
		"letter_spacing" => array(0, 0.6), // relative to font size
		"v_scatter" => .2, // 0...1
...
function img_code($code) {
	...
	$im=imagecreatefrompng(img_dir."back.png");
